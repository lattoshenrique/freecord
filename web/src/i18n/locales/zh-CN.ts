...
export const zhCN: Catalog = {
  ...
  'prejoin.errorTitle': '好吧，它坏了',
  'prejoin.errorBody': '房间没加载出来。刷新一下页面 —— 有效的次数多到我们不太好意思承认。',
  'prejoin.empty': '还没有人 —— 你会是 1 号进程。',
