...
export const esES: Catalog = {
  ...
  'chat.search': 'Buscar en los mensajes',
  'chat.searchPlaceholder': 'Encontrar un mensaje…',
  'chat.searchClose': 'Cerrar la búsqueda',
  'chat.searchHits': { one: '{count} resultado', other: '{count} resultados' },
  'chat.searchNone': [
    'Nada por aquí. Prueba con menos palabras 🔍',
    'Cero resultados — y los acentos ya se ignoraron 🔍',
    'No hay nada. Compila, pero no está aquí 🔍',
    'Nada encontrado. Quizá eso se dijo en voz alta 🔍',
  ],
  'chat.save': 'Guardar la conversación',
  'chat.saveNote': 'Un archivo markdown, escrito aquí en el navegador — no se sube nada',
  'chat.transcript.title': 'Freecord — {room}',
  'chat.transcript.savedAt': 'Guardado el {when}',
  'chat.transcript.file': 'Envió un archivo: {files}',
  'chat.transcript.replyTo': 'a {name}',
  ...
  'cmd.arg.text': 'texto',
  'cmd.arg.code': 'código',
  'cmd.mic': 'Enciende o apaga el micrófono',
  'cmd.cam': 'Enciende o apaga la cámara',
  'cmd.sound': 'Enciende o apaga el sonido — el micrófono va con él',
  'cmd.share': 'Empieza o deja de compartir tu pantalla',
  'cmd.play': 'Pon algo para toda la sala, ahora mismo',
  'cmd.queue': 'Deja algo en la cola, detrás de lo que suena',
  'cmd.skip': 'Pasa a lo siguiente de la cola',
  'cmd.stop': 'Quita del escenario lo que la sala está viendo',
  'cmd.invite': 'Copia el enlace de la sala, con clave incluida',
  'cmd.file': 'Elige un archivo para enviarlo directo a los demás',
  'cmd.save': 'Guarda la conversación en un archivo markdown',
  'cmd.search': 'Busca algo que se dijo aquí',
  'cmd.lang': 'Cambia el idioma de la aplicación',
  'cmd.me': 'Di lo que estás haciendo, en cursiva',
  'cmd.shrug': 'Añade un ¯\\_(ツ)_/¯ a lo que vas a enviar',
  'cmd.leave': 'Salir de la sala',
  'cmd.usage': 'Ese necesita algo después: {usage}',
  'cmd.unknown': 'Aquí no hay ningún /{name}. Escribe / para ver los que hay.',
  'cmd.nothingOn': 'La sala no tiene nada puesto ahora mismo.',
  'cmd.toShelf': 'Nada de aquí reproduce eso por sí solo: la estantería se quedó con el enlace y puede preguntarle a la página qué tiene.',
  'cmd.noLang': 'No hay ningún idioma con ese nombre. Esta versión habla {codes}.',
  'cmd.nothingYet': 'Aquí todavía no se ha dicho nada.',
  'cmd.noScreen': 'Este navegador no entrega una pantalla.',
  ...
  'file.pastedText': 'Demasiado largo para un mensaje — se fue como archivo.',
  'file.pastedCode': 'Más largo de lo que cabe en un mensaje — se fue como archivo {language}.',
