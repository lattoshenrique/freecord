...
export const jaJP: Catalog = {
  ...
  'how.step.talk.body':
    '全員がマイクもカメラも切った状態で入り、使いたいものだけを自分で入れます。上限は 12 人。音声と画面共有は常に優先されます。席を奪い合うのはカメラの方で、部屋が埋まるほど同時に映せる数は減り、それぞれの画質も自動的に調整されます。',
  ...
  'how.chat.body':
    'メッセージはリンクに載ってきた鍵で自分のブラウザ内で暗号化されるので、サーバーは読めない文字列を中継するだけです。保存はしません。部屋が閉じれば会話も一緒に消えます。',

  'how.screen.title': '画面共有は一度に一人、ツリー状に中継',
  'how.screen.body':
    '画面共有はサーバー側で一人にロックされ、その人の接続が切れてもロックは解放されます。映像は共有者から全員へ送られるのではなく、まず 3 人へ、その 3 人がさらに 3 人へ転送します。だから誰の上り帯域も部屋の人数に比例して増えません。',

  'how.limits.title': '部屋が従うルール',
  'how.limits.body':
    '1 部屋 12 人まで。誰もいない部屋は 15 分で閉じます。35 秒応答しないブラウザは席を失うので、固まったタブが席を占め続けることはありません。12 人を超えるとメッシュは誠実な答えではなくなります。次の一手は、画面共有と同じようにピア同士で中継することです。',
  ...
  'community.source.body':
    'すべて GitHub に MIT ライセンスで置いてあります。使うのも、フォークするのも、自分でホストするのも自由です。アーキテクチャ文書は正直な方の版です。ピアツーピアのメッシュが実際にどれだけのコストを払うのか、なぜルームが 12 人で止まるのか、どの技術的負債が隠されずに記録されているのか。',
