...
export const jaJP: Catalog = {
  ...
  'home.create': 'ルームを作成',
  'home.creating': '立ち上げ中…',
  'home.createFailed': 'ルームが起動を拒みました。もう一度どうぞ。',
  'home.join': 'ルームに参加',
  ...
  'invite.copy': '招待',
  'invite.copied': 'コピーしました！どこかに貼ってください。',
  ...
  'prejoin.errorTitle': 'はい、壊れました',
  'prejoin.errorBody': 'ルームを読み込めませんでした。ページを再読み込みしてください — 認めたくないくらいの確率で直ります。',
  'prejoin.empty': 'まだ誰もいません — あなたが PID 1 になります。',
  ...
  'room.loading': 'ルームを起動中…',
  'room.connecting': 'ICE 候補を交換中…',
  ...
  'chat.title': 'ルームチャット',
  'chat.empty': 'まだメッセージはありません。ピコッ — 挨拶してみましょう 👋',
  'chat.noKey':
