...
- A **tool shelf** in the dock, one tool so far: watching YouTube
  ...
  late lands where the room already is. There is a shared **queue** behind
  what is playing (anyone adds to it, jumps to one, or drops one), and a
  **playlist link** plays as itself: when it steps to its next video the
  room follows, and when it runs out the queue takes over.
